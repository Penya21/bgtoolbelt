...
public abstract interface TaskDao {
    ...
    @androidx.room.Query(value = "UPDATE user_entity SET lastUpdate = :timestamp WHERE email = :email")
    public abstract int updateLastUpdateTimestamp(@org.jetbrains.annotations.NotNull()
    java.lang.String email, long timestamp);
    ...
    @androidx.room.Query(value = "UPDATE user_entity SET sponsoredList = :list WHERE email = :email")
    public abstract int updateCustomList(@org.jetbrains.annotations.NotNull()
    java.lang.String email, @org.jetbrains.annotations.NotNull()
    java.util.List<com.kitam.bgapp.data.data.BoardGame> list);
