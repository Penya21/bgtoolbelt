...
public class BoardGameProperty$$TypeAdapter implements TypeAdapter<BoardGameProperty> {
  private Map<String, AttributeBinder<ValueHolder>> attributeBinders = new  HashMap<String, AttributeBinder<ValueHolder>>();

  public BoardGameProperty$$TypeAdapter() {
  ...
  @Override
  public BoardGameProperty fromXml(XmlReader reader, TikXmlConfig config) throws IOException {
    ...
    return new BoardGameProperty(value.type, value.id, value.value);
  }

  @Override
  public void toXml(XmlWriter writer, TikXmlConfig config, BoardGameProperty value,
      String overridingXmlElementTagName) throws IOException {
    if (value != null) {
      if (overridingXmlElementTagName == null) {
        writer.beginElement("boardGameProperty");
      } else {
